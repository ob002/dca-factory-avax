...
export interface MockBenqiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MockBenqi extends BaseContract {
  connect(runner?: ContractRunner | null): MockBenqi;
  waitForDeployment(): Promise<this>;

  interface: MockBenqiInterface;
